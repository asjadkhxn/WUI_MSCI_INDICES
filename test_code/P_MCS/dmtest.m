%%% modified by Yaojie Zhang, 2018/06/03
%%% e1 and e2 are revised to losses (function)

function [DM p_DM] = dmtest(e1, e2, h)
...
%   ---***--- When p_DM is smaller than 0.1,0.01, or .., the model2 (e2) is
%   signifcantly better than model1 (e1).  ---***---
...
% Define the losses (modified by yaojie)
d = e1 - e2;
...
p_DM = 1 - normcdf(DM);  %(Added by yaojie)
